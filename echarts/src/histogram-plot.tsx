...
import { CustomFunctionCall } from 'react-ai-assist';
    ...
    <AutoSizer>
      {({ height, width }) => (
        <div style={{ height, width }}>
          <div className="h-full w-full flex flex-col rounded-lg bg-white p-6 text-gray-900 shadow-secondary-1 dark:bg-gray-950 dark:text-gray-100">
            <div className="flex-col items-start pb-2 pt-2">
